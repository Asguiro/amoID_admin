...
export function loader({ request }: Route.LoaderArgs) { return loadVerifications(request); }
export default function RouteComponent({ loaderData }: Route.ComponentProps) {
  return <VerificationsPage result={loaderData.result} q={loaderData.query.q} />;
}
